...
elseif screenparms.rect(3)/imageInfo.Width > 1 || screenparms.rect(4)/imageInfo.Height > 1 %testing
    newWidth = imageInfo.Width * max([screenparms.rect(3)/imageInfo.Width, screenparms.rect(4)/imageInfo.Height])-350;
    newHeight = imageInfo.Height * min([screenparms.rect(3)/imageInfo.Width, screenparms.rect(4)/imageInfo.Height]);
    [imageRect,dh,dv] = CenterRect([0 0 newWidth newHeight], screenparms.rect);
